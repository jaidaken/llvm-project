...
void X86PassConfig::addPreEmitPass() {
  ...
  addPass(createX86SwapEaxZeroPass());
  ...
  addPass(createX86PreferBaseAdjustPass());
  addPass(createX86DelayedCalleeSavePass());
  ...
  addPass(createX86PreferByteParamLoadPass());
